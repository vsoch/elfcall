...
# -*- coding: utf-8 -*-
#
# elfcall documentation build configuration file, created by
...
from elfcall.version import __version__ as version
...
latex_documents = [
    ("index", "elfcall.tex", "elfcall Documentation", "Vanessa Sochat", "manual"),
]
